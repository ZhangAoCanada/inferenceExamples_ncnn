...
int main(int argc, char** argv)
{
    ...
    if (argc < 3)
    {
        fprintf(stderr, "Usage: %s [mode=0,1,2] [v4l input device or image]\n", argv[0]);
        return -1;
    }
	...
	{
		std::cout << "Please input right mode (choose from 0, 1, 2)" << std::endl;
	}
